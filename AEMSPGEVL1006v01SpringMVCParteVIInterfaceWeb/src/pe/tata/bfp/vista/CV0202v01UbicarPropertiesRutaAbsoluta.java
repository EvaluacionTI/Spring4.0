...
public class CV0202v01UbicarPropertiesRutaAbsoluta {
	public static void main(String[] args) {
		...
		try {
			...
			oPropiedad.load(new FileReader("F:\\2018\\03Tecnologia\\10Spring4.3.8\\04Desarrollo\\AEMSPGEVL1006v01SpringMVCParteVIInterfaceWeb\\WebContent\\WEB-INF\\properties\\messages_ES.properties"));
