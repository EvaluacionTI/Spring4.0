...
public class CDUsuarioDAOStatic implements CIUsuarioDAO{
	private static Logger moLog = LogManager.getLogger(CDUsuarioDAOStatic.class);
	private static HashMap<Integer, CE01Usuario> oTabla;
	
	public CDUsuarioDAOStatic() {
