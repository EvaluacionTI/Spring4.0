...
import etg.bbva.modelo.impl.CDUsuarioDAOStatic;
import junit.framework.TestCase;
import junit.textui.TestRunner;

public class CDUsuarioDAOStaticTest extends TestCase {
	private static final Logger moLog = LogManager.getLogger(CDUsuarioDAOStaticTest.class);
	
	private ClassPathXmlApplicationContext oCntx;
	private CDUsuarioDAOStatic oCDUsuario;
	...
	protected void setUp() throws IOException{
		...
		oCDUsuario = (CDUsuarioDAOStatic) oCntx.getBean("idCDUsuarioStatic");
	...
	public static void main(String[] args) {
		TestRunner.run(CDUsuarioDAOStaticTest.class);
