...
public class CVIniciarSpringBootWebApplication {
	...
	public static void main(String[] args){
		...
		moLog.info("=====> 2. http://localhost:8005/listadoPersona \n");
		moLog.info("=====> 3. http://localhost:8005/IniciarControlador \n");
		moLog.info("=====> 4. http://localhost:8005/");
		moLog.info("=====> 5. http://localhost:8005/saludoMensaje");
