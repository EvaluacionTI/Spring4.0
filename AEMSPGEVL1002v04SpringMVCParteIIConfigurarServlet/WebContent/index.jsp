...
<body>
	...
	<br>
	D. Ejecutar el proyecto, en la URL
	
	<p>http://localhost:8085/LeasingConfigurarServlet</p>
	<p>http://localhost:8085/LeasingConfigurarServlet/hello.htm</p>
	<p>http://localhost:8085/LeasingConfigurarServlet/index.jsp</p>
