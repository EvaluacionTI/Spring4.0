...
/*
 * A partir de la versión 1.2 de Spring se define:
...
public class CV0201v01PersonaRestControllerExterno {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. El mapping @RequestMapping para el url está en la clase CCPersona");
		
		SpringApplication.run(CV0201v01PersonaRestControllerExterno.class, args);
		System.out.println("3. Ejecutar en la url : localhost:8080/listado");		
	}
}
