package etg.bbva.evalua.spring.restful.vista;
...
import etg.bbva.evalua.spring.restful.entidad.CEPersona;
...
public class CV0101v01PersonaRestControllerInterno {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. El mapping @RequestMapping para el url está en la clase principal del métod listadoPersonas");
		SpringApplication.run(CV0101v01PersonaRestControllerInterno.class, args);
		System.out.println("3. Ejecutar en la url : localhost:8080/todos");		
	}
