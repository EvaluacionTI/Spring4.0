...
public class CV0201v02jFrameMostrarColumnasDefaultTableModel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					CV0201v02jFrameMostrarColumnasDefaultTableModel frame = new CV0201v02jFrameMostrarColumnasDefaultTableModel();
	 ...
	 * Create the frame.
	 */
	public CV0201v02jFrameMostrarColumnasDefaultTableModel() {
